...
export default async function handler(
    ...
    try {
        ...
        const addSkillToColleagueQuery = await sql`INSERT INTO colleagues_skills(colleague_id, skill_id, ability, interest)
                                                                    SELECT ${newSkill.colleague_id}, ${newSkill.skill_id}, ${newSkill.ability}, ${newSkill.interest} 
                                                                    WHERE
                                                                    NOT EXISTS (
